const DEFAULT_LEVEL_CONFIG = [
  ...
  },
  {
    ...
    material_max: 5,
    data_max: 0,
    unlock: "Energie a materiály jsou nyní dostupné. V Infocentru lze nově objevovat materiál.",
    unlock_items: [
  ...
  },
  {
    ...
    material_max: 5,
    data_max: 5,
    unlock: "Data jsou nyní dostupná.",
    unlock_items: [{ type: "data" }],
  },
  { level: 4, xp_required: 100, energy_max: 3, material_max: 5, data_max: 5 },
  { level: 5, xp_required: 100, energy_max: 3, material_max: 10, data_max: 10 },
  { level: 6, xp_required: 200, energy_max: 3, material_max: 10, data_max: 10 },
  { level: 7, xp_required: 200, energy_max: 4, material_max: 10, data_max: 10 },
  { level: 8, xp_required: 300, energy_max: 4, material_max: 15, data_max: 15 },
  { level: 9, xp_required: 400, energy_max: 4, material_max: 15, data_max: 15 },
  { level: 10, xp_required: 500, energy_max: 5, material_max: 20, data_max: 20 },
  { level: 11, xp_required: 600, energy_max: 5, material_max: 20, data_max: 20 },
  { level: 12, xp_required: 700, energy_max: 6, material_max: 20, data_max: 20 },
  { level: 13, xp_required: 800, energy_max: 6, material_max: 20, data_max: 20 },
  { level: 14, xp_required: 900, energy_max: 7, material_max: 20, data_max: 20 },
  { level: 15, xp_required: 1000, energy_max: 7, material_max: 25, data_max: 25 },
  { level: 16, xp_required: 1200, energy_max: 8, material_max: 25, data_max: 25 },
  { level: 17, xp_required: 1400, energy_max: 9, material_max: 25, data_max: 25 },
  { level: 18, xp_required: 1600, energy_max: 10, material_max: 25, data_max: 25 },
  { level: 19, xp_required: 1800, energy_max: 10, material_max: 25, data_max: 25 },
  { level: 20, xp_required: 2000, energy_max: 10, material_max: 25, data_max: 25 },
];
  ...
  async function loadAgentAndLevels() {
    try {
      ...
      if (data.agent) {
        ...
        agentState.hqCityId = data.agent.hq_city_id ?? null;
